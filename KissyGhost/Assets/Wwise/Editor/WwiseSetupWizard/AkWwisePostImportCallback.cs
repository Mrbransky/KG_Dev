...
public class AkWwisePostImportCallback
{
	...
	static void CheckWwiseGlobalExistance()
	{
        ...
        if (!settings.OldProject && (String.IsNullOrEmpty(EditorSceneManager.GetActiveScene().name) || s_CurrentScene != EditorSceneManager.GetActiveScene().name))
		{			
            ...
            s_CurrentScene = EditorSceneManager.GetActiveScene().name;
		}
	}
}
