...
public class AkBasePathGetter
{
    ...
    static string GetPlatformBasePathEditor()
    {
        try
        {
            ...
            {
                Debug.LogWarning("WwiseUnity: Your platform subfolder does not match your platform name. You will need to create a custom platform name getter for your game. See section \"Using Wwise Custom Platforms in Unity\" of the Wwise Unity integration documentation for more information.");
            }
