...
public class PaletteLoader : MonoBehaviour {
	...
	void Start () 
    {
        ...
        palettesToLoad = CharSelectMan_GO.GetComponent<CharacterSelectManager>().AvailablePalettesList;
        int[] playerPosInPalettesList = CharSelectMan_GO.GetComponent<CharacterSelectManager>().PlayerPosInPaletteList;
        ...
        List<PaletteSwapper> playerPaletteSwappers = CharSelectMan_GO.GetComponent<CharacterSelectManager>().PlayerPaletteSwapperArray.ToList();
